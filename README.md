...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/1.png" width="70%" height="70%" /><br>
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/2.png" width="70%" height="70%" /><br>
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/3.png" width="70%" height="70%" /><br>
```python
df = pd.read_csv('bankloan.csv', encoding='gbk', header=None)
df.head()
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/4.png" width="70%" height="70%" /><br>
还可以用以下方法自己指定列标签。
```python
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/5.png" width="70%" height="70%" /><br>
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/6.png" width="70%" height="70%" /><br>
### 1.2 索引
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/7.png" width="70%" height="70%" /><br>
```python
df = pd.read_csv('bankloan.csv', encoding='gbk', index_col=['id', '年龄'])
df.head()
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/8.png" width="70%" height="70%" /><br>
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/9.png" width="70%" height="70%" /><br>
```python
#返回数据框维度的元组
df.shape
```
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/10.png" width="40%" height="40%" /><br>
```python
# 显示数据框的简明摘要，包括每列非空值的数量
df.info()
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/11.png" width="60%" height="60%" /><br>
```python
# 返回每列数据的有效描述性统计
df.describe()
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/12.png" width="80%" height="80%" /><br>
```python
# `.tail()` 返回最后几行，但是也可以指定你希望返回的行数
df.tail(2)
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/13.png" width="70%" height="70%" /><br>
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/14.png" width="20%" height="20%" /><br>
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/15.png" width="35%" height="35%" /><br>
```python
# 使用iloc重复以上步骤
df1 = df.iloc[:,:5]
df1.head()
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/16.png" width="35%" height="35%" /><br>
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/19.png" width="70%" height="70%" /><br>
```python
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/21.png" width="70%" height="70%" /><br>
## 3.4 重命名列
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/22.png" width="70%" height="70%" /><br>
# 4. 得出结论
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/24.png" width="70%" height="70%" /><br>
```python
# 30岁（含）以下人群、31岁到39岁及40岁（含）以上人群的总收入总比情况
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/25.png" width="70%" height="70%" /><br>
# 6. 简单可视化
```python
# 绘制收入与信用卡负债之间的关系图
...
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/26.png" width="70%" height="70%" /><br>
```python
# 绘制学历分布图
df1['education'].hist()
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/27.png" width="70%" height="70%" /><br>
```python
# 绘制工龄变量的箱线图
df1['w_age'].plot(kind='box')
```
output：<br>
<img src="https://github.com/lubin007/Data-analysis-process/blob/master/img/28.png" width="70%" height="70%" /><br>
